...
# Script to encode questionnaire-lens.js to base64 and update questionnaire-lens.json

SCRIPT_DIR="$(cd "$(dirname "${BASH_SOURCE[0]}")" && pwd)"
PROJECT_DIR="$(dirname "$SCRIPT_DIR")"

JS_FILE="$PROJECT_DIR/questionnaire-lens.js"
JSON_FILE="$PROJECT_DIR/questionnaire-lens.json"
...
console.log('✅ Updated questionnaire-lens.json with encoded JS');
"
